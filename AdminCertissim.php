    ...
    public function calibrate()
    {
					...
					IF(
						...
						FROM `'._DB_PREFIX_.'certissim_order` c3 
							LEFT JOIN `'._DB_PREFIX_.'certissim_state` cs2 ON c3.id_certissim_state = cs2.id_certissim_state 
								WHERE c3.id_order = a.id_order AND c3.paiement NOT IN ("'.$fieldvalues.'")),
						("not concerned")
					)
				)
			)
        ...
        if (_PS_VERSION_ >= '1.5') {
            ...
            $column_description = array(
                ...
                'search' => true,
                'icon' => array(
                    '0' => '../../modules/fianetfraud/views/img/0.gif',
                    '-1' => '../../modules/fianetfraud/views/img/-1.gif',
                    '100' => '../../modules/fianetfraud/views/img/100.gif',
                    'error' => '../../modules/fianetfraud/views/img/error.gif',
                    'sent' => '../../modules/fianetfraud/views/img/sent.gif',
                    'ready to send' => '../../modules/fianetfraud/views/img/ready-to-send.gif',
                    'default' => '../../modules/fianetfraud/views/img/not-concerned.gif'
                ));
