...
class AdminCertissimController extends AdminOrders
{
    ...
    public function displayTop()
    {
        ...
        $img_eval = _PS_BASE_URL_ . __PS_BASE_URI__ . 'modules/fianetfraud/views/img/certissim-wait.png';
        $link_reeval = 'index.php?tab=AdminCertissim&action=getReevaluations&token=' . Tools::getAdminTokenLite('AdminCertissim');
        $img_reeval = _PS_BASE_URL_ . __PS_BASE_URI__ . 'modules/fianetfraud/views/img/certissim-reeval.png';
        $header = '<fieldset>
